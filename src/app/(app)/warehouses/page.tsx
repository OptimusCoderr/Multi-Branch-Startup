  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        {canManage && (
          <Link href="/warehouses/new" className="rounded-md bg-black px-4 py-2 text-sm font-medium text-white">
            New warehouse
          </Link>
        )}
      </div>
                ...
                <tr key={w.id} className="border-b border-gray-100">
                  ...
                  <td className="py-2 text-right">
                    <div className="flex justify-end gap-3">
                      {canManage && (
                        <>
                          <Link href={`/warehouses/${w.id}`} className="text-blue-600 hover:underline">
                            Edit
                          </Link>
